...
# Configuración
ruta_base = r"E:\HDD1 Backup\Doks back uo\01_Petita Ideas\sorted"   # 🔧 Cambia a la carpeta base (la que contiene los años)
...
def mover_thumbnails(ruta_base):
    ...
    for carpeta_ano in os.listdir(ruta_base):
        ...
        for carpeta_mes in os.listdir(ruta_ano):
            ...
            # Recorrer archivos y mover los que sean imágenes < 20 KB
    ...
    print("\n Proceso completado")
    print(f" Total de imágenes movidas: {total_movidos}")
